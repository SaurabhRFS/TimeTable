...
import com.kits.timetable.repository.TimetableRepository; // Added this!
...
public class DataSeeder {
    ...
    @Bean
    CommandLineRunner initDatabase(TimeSlotRepository timeSlotRepository, RoomRepository roomRepository, TimetableRepository timetableRepository) {
        return args -> {
            
            // 1. SAFELY WIPE ONLY THE TIMETABLE AND TIMES (Saves your 30 mins of manual data entry!)
            timetableRepository.deleteAll();
            timeSlotRepository.deleteAll();

            // 2. INSERT EXACT PDF TIME SLOTS
            timeSlotRepository.saveAll(Arrays.asList(
                ...
                new TimeSlot(null, LocalTime.of(13, 0), LocalTime.of(14, 0), 5, "LECTURE"),  // 1:00 - 2:00
                new TimeSlot(null, LocalTime.of(14, 0), LocalTime.of(14, 55), 6, "LECTURE"),  // 2:00 - 2:55
                new TimeSlot(null, LocalTime.of(14, 55), LocalTime.of(15, 55), 7, "LECTURE"), // 2:55 - 3:55
                new TimeSlot(null, LocalTime.of(15, 55), LocalTime.of(16, 50), 8, "LECTURE")  // 3:55 - 4:50
            ));
